import { BriefIntakeForm } from "@/components/studio/BriefIntakeForm";
    ...
    <section style={{ display: "grid", gap: 24 }}>
      <div>
        ...
        <p style={{ color: "#c8d6eb", maxWidth: 720 }}>
          O intake agora ja abre o briefing e, opcionalmente, a request criativa inicial no mesmo fluxo. Isso deixa a
          entrada mais proxima do uso real do estudio central da FBR.
        </p>
      </div>
