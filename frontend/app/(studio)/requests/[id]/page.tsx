...
export default async function RequestDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { request, brief, deliverables, approvalSteps, feedbackThreads, assetVersions } = detail;
    ...
    <section style={{ display: "grid", gap: 18 }}>
      <div>
        ...
        <p style={{ color: "#c8d6eb", maxWidth: 760 }}>
          Detalhe mestra inicial com briefing, deliverables, gates, feedbacks e versoes. A proxima camada sera ligar
          acoes mutativas reais e timeline operacional.
        </p>
      </div>
